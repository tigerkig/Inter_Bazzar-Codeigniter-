...
<div class="modal fade" id="refundProduct" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-custom">
            <!-- form start -->
            <?php echo form_open('refund-request'); ?>
            <div class="modal-header">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
							...
							<input type="hidden" name="refund_order_product_id" id="refund_order_product_id" value="">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
		...
		function refund_order_product(order_product_id) {
			$('#refund_order_product_id').val(order_product_id);
			$('#refundProduct').modal();
		}
