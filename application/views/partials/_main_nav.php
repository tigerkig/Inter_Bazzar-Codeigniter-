...
<?php if ($this->general_settings->selected_navigation == 1): ?>
    <div class="container-fluid">
        <div class="navbar navbar-light navbar-expand" style="width:100%">
            <ul class="nav navbar-nav mega-menu btn-product-promote" style="width:100%; justify-content:center;">
                <?php $limit = $this->general_settings->menu_limit;
                $count = 1;
                if (!empty($this->parent_categories)):
                    foreach ($this->parent_categories as $category):
                        if ($count <= $limit):?>
                            <li class="nav-item dropdown" data-category-id="<?php echo $category->id; ?>" style=" height: 45px;padding-right:5px">
                                <a href="<?php echo generate_category_url($category); ?>" class="nav-link dropdown-toggle" style="font-weight: bold; color: #fff; line-height: 0px; top: 12px; margin-right: 0px; padding: 5px;">
                                    <?php echo category_name($category); ?><i class="icon-arrow-down" style="padding-left: 5px;"></i>
                                </a>
                    ...
                    if (item_count($this->parent_categories) > $limit): ?>
                        <li class="nav-item dropdown menu-li-more" style=" height: 45px;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" style="font-weight: bold; color: #000; line-height: 0px; top: 12px; margin-right: 0px; padding: 12px 8px;"><?php echo trans("more"); ?></a>
