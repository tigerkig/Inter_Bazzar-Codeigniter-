...
<!DOCTYPE html>
<html lang="<?php echo $this->selected_lang->short_form ?>" dir="ltr" class="bp-panel-active cookies filereader draganddrop no-touchevents mouseevents"><head>
    ...
    <div class="main-menu">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="nav-main btn-product-promote" style="margin-right:0px">
                ...
                <div class="row">
                    <div class="nav-mobile-header-container">
                        ...
                        <div class="mobile-logo">
                            <a href="<?php echo lang_base_url(); ?>"><img src="<?php echo get_logo_mobile($this->general_settings); ?>" alt="logo" class="logo"></a>
                        </div>
                        <?php if (is_sale_active()): ?>
...
<?php if (!$this->auth_check): ?>
    ...
    <div class="modal fade" id="loginModal" role="dialog">
        <div class="modal-dialog modal-dialog-centered login-modal" role="document">
            ...
            <!-- <div>
                <center><img src="http://sanalpos365.com/wp-content/uploads/2020/02/sanal_pos_logow_m.png" alt="Sanal Pos 365 | Online ödeme alın, bayi olun alt bayilik verin." /></center>
                <div class="container">
                    <section id="content">
                        <form action="">
                            <h1>Giriş Formu</h1>
                            <div>
                                <input type="text" placeholder="Kullanıcı Adı" required="" id="username" />
                            </div>
                            <div>
                                <input type="password" placeholder="Şifre" required="" id="password" />
                            </div>
                            <div>
