                                               ...
                                               <td style="width: 50%">
                                                    <div class="table-item-product">
                                                        ...
                                                        <div class="right">
                                                            ...
                                                            <p><span class="span-product-dtl-table">


                                                                <?php echo trans("unit_price"); ?>:</span>

                                                                  <?php echo price_formatted(currency_convert($item->product_unit_price, $item->product_currency, 'EUR'), 'EUR') ?> (<?php echo price_formatted($item->product_unit_price, $item->product_currency); ?>)                                                            </p>
                                                            ...
                                                            <?php if ($item->product_type == 'physical') : ?>
                                                                <p><span class="span-product-dtl-table"><?php echo trans("shipping"); ?>:</span>
                                                                      ...
                                                                      <?php echo price_formatted(currency_convert($item->product_shipping_cost, $item->product_currency, 'EUR'), 'EUR') ?> (<?php echo price_formatted($item->product_shipping_cost, $item->product_currency); ?>)</p>
                                                            <?php endif; ?>
                                                            <?php if (!empty($item->product_vat)) : ?>
                                                                <p><span class="span-product-dtl-table"><?php echo trans("vat"); ?>&nbsp;(<?php echo $item->product_vat_rate; ?>%):</span>

                                                                    <?php echo price_formatted(currency_convert($item->product_vat, $item->product_currency, 'EUR'), 'EUR') ?> ( <?php echo price_formatted($item->product_vat, $item->product_currency); ?>)
                                                ...
                                                <td style="width: 25%;">
                                                    <?php if ($item->order_status == "shipped") : ?>
                                                        <button type="submit" class="mt-2 btn btn-sm btn-custom btn-block" onclick="approve_order_product('<?php echo $item->id; ?>','<?php echo trans("confirm_approve_order"); ?>');"><i class="icon-check"></i><?php echo trans("confirm_order_received"); ?></button>
                                                        <small class="text-confirm-order-table"><?php echo trans("confirm_order_received_exp"); ?></small>
													
													<?php if(intval($item->not_refundable) == 1): ?>
													<button onclick="refund_order_product('<?php echo $item->id; ?>')" type="button" class="mt-2 btn btn-sm btn-custom btn-block"  data-toggle="tooltip" data-placement="left" title="<?php echo trans('accepted_refund_agreement'); ?>">'<i class=""></i><?php echo trans("refund_order_request"); ?></button>
													
													<?php else: ?>
													<button type="button" class="btn btn-sm btn-custom btn-block" onclick=""><i class=""></i><?php echo trans("refund_order_request"); ?></button>
													<?php endif; ?>
