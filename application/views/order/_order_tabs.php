...
<div class="profile-tabs">
	<ul class="nav">
		...
		<li class="nav-item <?php echo ($active_tab == 'refund_orders') ? 'active' : ''; ?>">
			<a class="nav-link" href="<?php echo generate_url("orders", "refund_orders"); ?>">
				<span><?php echo trans("refund_orders"); ?></span>
			</a>
		</li>
	</ul>
</div>
