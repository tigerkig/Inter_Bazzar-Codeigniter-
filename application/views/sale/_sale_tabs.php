...
<div class="profile-tabs">
	<ul class="nav">
		...
		<li class="nav-item <?php echo ($active_tab == 'refunded_sales') ? 'active' : ''; ?>">
			<a class="nav-link" href="<?php echo generate_url("sales","refunded_sales"); ?>">
				<span><?php echo trans("refunded_sales"); ?></span>
			</a>
		</li>
	</ul>
</div>
