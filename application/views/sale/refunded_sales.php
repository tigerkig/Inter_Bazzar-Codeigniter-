									...
									<?php foreach ($orders as $order):
										...
										if (!empty($sale)):?>
											<tr>
												...
												<td><?php // echo $total.' '.$sale->price_total.' '.$sale->price_currency.' '; 
													echo price_formatted($total, $sale->price_currency);
													//echo price_formatted(currency_convert($total, 'USD','EUR'),'EUR');
												 ?></td>
												<td>
												...
												<td>
													<?php  echo $order->refund_track_code; ?>
												</td>
