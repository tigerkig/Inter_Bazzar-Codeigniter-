...
<div class="row col-md-12" style="padding:0px; position:absolute">
	<div class="col-md-6" style="padding-left:0px">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					<label class="control-label"><?php echo trans('logo_mobile'); ?></label>
					<div style="margin-bottom: 10px;">
						<img src="<?php echo get_logo_mobile($this->general_settings); ?>" alt="logo" style="max-width: 160px; max-height: 160px;">
					</div>
					<div class="display-block">
						<a class='btn btn-success btn-sm btn-file-upload'>
							<?php echo trans('select_logo'); ?>
							<input type="file" name="logo_mobile" size="40" accept=".png, .jpg, .jpeg" onchange="$('#upload-file-info3').html($(this).val());">
						</a>
						(.png, .jpg, .jpeg)
					</div>
					<span class='label label-info' id="upload-file-info3"></span>
