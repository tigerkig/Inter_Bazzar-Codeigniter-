...
<div class="row" style="margin-bottom: 5px; width:100%; background-color: white">
	<div class="col-md-12">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<p>
						...
						<label for="last_modification_2" class="cursor-pointer">&nbsp;<?php echo "Server's Response"; ?></label>
					</p>
				</div>
