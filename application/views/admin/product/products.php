                        ...
                        <?php foreach ($products as $item): ?>
                            <tr>
                                ...
                                <td class="td-product">
                                    ...
                                    <div class="img-table" style="height: 100px;">
                                        <a href="<?php echo generate_product_url($item); ?>">
                                            <img src="<?php echo get_product_image($item->id, 'image_small'); ?>" style="height:70px" data-src="" alt="" class="lazyload img-responsive post-image"/>
                                        </a>
                                    </div>
                                    <a href="<?php echo generate_product_url($item); ?>" class="table-product-title">
                                ...
                                <td>
                                    ...
                                    if (!empty($user)): ?>
                                        <a href="<?php echo generate_profile_url($user->slug); ?>" class="table-username">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            ...
                                            <?php endif; ?>
                                            <li>
                                                <!-- <a href="<?php echo generate_url("sell_now", "edit_product") . "/" . $item->id; ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a> -->
                                                <a href="<?php echo admin_url()."sell_now" . "/" . $item->id; ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                            </li>
                                            <li>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog" style="right: -10%;">
