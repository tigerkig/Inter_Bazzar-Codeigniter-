...
<!-- Wrapper -->
<div class="col-md-12 box" style="padding:0px" id="wrapper" >
        <div class="container">
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="form-box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 m-b-10">
                                                            <button type="button" class="btn btn-sm btn-success color-white btn_ck_add_image"><i class="icon-image"></i><?php echo trans("add_image"); ?></button>
                                                ...
                                                <div class="row ">
                                                    <div class="col-12 m-b-30">
                                                        ...
                                                        <?php $this->load->view("admin/product/_image_update_box"); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo generate_url("sell_now", "product_details") . "/" . $product->id; ?>" class="btn btn-lg btn-primary btn-custom float-right"><?php echo trans("edit_details"); ?></a>
                                                <button type="submit" class="btn btn-lg btn-success btn-custom float-right m-r-10"><?php echo trans("save_changes"); ?></button>
                                            <?php endif; ?>
                                        </div>
                                        <?php echo form_close(); ?>
                                    </div>
