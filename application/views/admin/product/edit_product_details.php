                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div>                    
                                        ...
                                        <div class="form-group">
                                            <?php if ($product->is_draft == 1): ?>
                                                <a href="<?php echo generate_url("sell_now") . "/" . $product->id; ?>" class="btn btn-warning btn-lg btn-custom float-left"><?php echo trans("back"); ?></a>
                                                <button type="submit" name="submit" value="submit" class="btn btn-lg btn-custom btn-info float-right"><?php echo trans("submit"); ?></button>
                                                <button type="submit" name="submit" value="save_as_draft" class="btn btn-lg btn-secondary btn-success color-white float-right m-r-10"><?php echo trans("save_as_draft"); ?></button>
                                            <?php else: ?>
                                                <a href="<?php echo generate_url("sell_now", "edit_product") . "/" . $product->id; ?>" id="btn_tab_product_images" class="btn btn-warning btn-lg btn-custom float-left"><?php echo trans("back"); ?></a>
                                                <button type="submit" name="submit" value="save_changes" class="btn btn-lg btn-custom float-right btn-info"><?php echo trans("save_changes"); ?></button>
                                            <?php endif; ?>
                                        </div>
                                    </div>        
