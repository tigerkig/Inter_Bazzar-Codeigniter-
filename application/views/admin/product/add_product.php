        ...
        <div class="container">
            <div class="row">
                <div id="content" class="col-12">
                    ...
                    <h1 class="page-title page-title-product">Add Product</h1>
                            ...
                            <div class="col-12 col-md-12 col-lg-11">
                                ...
                                <div class="row">
                                    ...
                                    <?php echo form_open('add-product-post', ['id' => 'form_validate', 'onkeypress' => "return event.keyCode != 13;"]); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 m-b-5">
                                                            <button type="button" class="btn btn-sm btn-secondary btn-success color-white btn_ck_add_image m-b-5"><?php echo trans("add_image"); ?></button>
                                                            <button type="button" class="btn btn-sm btn-info color-white btn_ck_add_video m-b-5"><?php echo trans("add_video"); ?></button>
                                                            <button type="button" class="btn btn-sm btn-warning color-white btn_ck_add_iframe m-b-5"><?php echo trans("add_iframe"); ?></button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-lg btn-custom float-right btn-info"><?php echo trans("save_and_continue"); ?></button>
                                        </div>
