...
<div class="row" style="position:absolute">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select name="default_product_currency" class="form-control q1q1">
    ...
    <div class="col-lg-7 col-md-12">
        ...
        <div class="box">
            <div class="box-body">
                <?php echo form_open('admin_controller/multiple_currency_settings_post'); ?>
                <!-- include message block -->
                <?php if (!empty($this->session->flashdata('multi_msg_settings'))):
                    $this->load->view('admin/includes/_messages');
                endif; ?>

                <div class="form-group">
                    <label class="control-label">Allow Currency For Shop<?php // echo trans('default_product_currency'); ?><?php // echo trans('add_multiple_currency'); ?></label>
                    <?php 
                        $default_multiple_currency = json_decode($this->payment_settings->default_multiple_currency);
                    ?>

                    <select name="default_multiple_currency[]" multiple class="form-control q1q1">
                        <?php if (!empty($currencies)):
                            foreach ($currencies as $item): ?>
                                <option value="<?php echo $item->id; ?>"
                                    <?php echo (in_array($item->id, $default_multiple_currency)) ? 'selected' : ''; ?>
                                 <?php // echo ($this->payment_settings->default_product_currency == $item->code) ? 'selected' : ''; ?>><?php echo $item->name . " (" . $item->hex . ")"; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-sm pull-right"><?php echo trans('save_changes'); ?></button>
                </div>
