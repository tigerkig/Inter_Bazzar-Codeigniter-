    ...
    <div class="col-lg-5 col-md-12">
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo trans('default_product_currency'); ?> Add Multiple Currency</label>
                    <select name="default_product_currency1" multiple class="form-control q1q1">
                        <?php if (!empty($currencies)):
                            foreach ($currencies as $item): ?>
                                <option value="<?php echo $item->code; ?>" <?php echo ($this->payment_settings->default_product_currency == $item->code) ? 'selected' : ''; ?>><?php echo $item->name . " (" . $item->hex . ")"; ?></option>
                            <?php endforeach; ?>
