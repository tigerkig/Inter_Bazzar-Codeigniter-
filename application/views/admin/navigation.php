                ...
                <div class="row nav-template-items">
                    <div class="col-md-6">
                        <div class="nav-template-item <?php echo ($this->general_settings->selected_navigation == 1) ? 'active' : ''; ?>" data-nav-id="1">
                            <img src="<?php echo base_url(); ?>assets/admin/img/nav_1.jpg" alt="" class="img-responsive" style="height:201px">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="nav-template-item <?php echo ($this->general_settings->selected_navigation == 2) ? 'active' : ''; ?>" data-nav-id="2">
                            <img src="<?php echo base_url(); ?>assets/admin/img/nav_2.jpg" alt="" class="img-responsive" style="height:201px">
                        </div>
                    </div>
                </div>
