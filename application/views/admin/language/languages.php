...
<div class="col-md-12" style="padding:0px; position:absolute">
	...
	<div class="col-lg-7 col-md-12" style="padding-right:0px">
		<div class="box">
			<div class="box-header with-border">
				<div class="pull-left">
									...
									<tr>
										...
										<td>
											<div class="dropdown">
												...
												<li>
														<a href="<?php echo admin_url(); ?>import-language/<?php echo html_escape($item->id); ?>"><i class="fa fa-upload option-icon"></i>Upload</a>
													</li>
													<li>
														<a href="<?php echo admin_url(); ?>export-language/<?php echo html_escape($item->id); ?>"><i class="fa fa-download option-icon"></i>Download</a>
													</li>
													<li>
