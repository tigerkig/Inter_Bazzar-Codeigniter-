...
<div class="col-md-12" style="position:absolute;padding:0px">
		<div class="box box-primary">
			<div class="box-header with-border">
				...
				<div class="right">
					<a href="<?php echo admin_url(); ?>categories" class="btn btn-primary btn-add-new">
			...
			<div class="box-body">
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-4 col-xs-12 col-option">
							<input type="radio" name="no_purchase" value="1" id="no_purchase_1" class="square-purple">
							<label for="no_purchase_1" class="option-label"><?php echo trans('yes'); ?></label>
						</div>
						<div class="col-sm-4 col-xs-12 col-option">
							<input type="radio" name="no_purchase" value="0" id="no_purchase_2" class="square-purple" checked>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-4 col-xs-12">
							<label>Not Refunddable</label>
						</div>
						<div class="col-sm-4 col-xs-12 col-option">
							<input type="radio" name="not_refundable" value="1" id="not_refundable1" class="square-purple">
							<label for="no_purchase_1" class="option-label"><?php echo trans('yes'); ?></label>
						</div>
						<div class="col-sm-4 col-xs-12 col-option">
							<input type="radio" name="not_refundable" value="0" id="not_refundable2" class="square-purple" checked>
							<label for="no_purchase_2" class="option-label"><?php echo trans('no'); ?></label>
						</div>
					</div>
				</div>
