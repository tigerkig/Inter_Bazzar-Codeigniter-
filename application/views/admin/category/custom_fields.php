...
<div class="col-md-12" style="padding:0px; position:absolute">
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="right">
                <a href="<?php echo admin_url(); ?>add-custom-field" class="btn btn-primary btn-add-new">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($item->field_type == 'checkbox' || $item->field_type == 'radio_button' || $item->field_type == 'dropdown'):
                                            ...
                                            <?php else: ?>
                                                <button class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp;<?php echo trans('add_to_product_filters'); ?></button>
                                            <?php endif;
                                        endif; ?>
                                        <?php echo form_close(); ?>
                                    </td>
