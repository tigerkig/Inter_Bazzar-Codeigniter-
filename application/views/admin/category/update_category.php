...
<div class="col-md-12" style="padding:0px; position">
    <div class="box box-primary">
        ...
        <div class="box-body" style="padding:40px">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <label><?php echo trans('no_purchase'); ?></label>
                    </div>
                    <div class="col-sm-4 col-xs-12 col-option">
                        <input type="radio" name="no_purchase" value="1" id="no_purchase_1" class="square-purple" <?php echo ($category->no_purchase == '1') ? 'checked' : ''; ?>>
                        <label for="no_purchase_1" class="option-label"><?php echo trans('yes'); ?></label>
                    </div>
                    <div class="col-sm-4 col-xs-12 col-option">
                        <input type="radio" name="no_purchase" value="0" id="no_purchase_2" class="square-purple" <?php echo ($category->no_purchase == '0') ? 'checked' : ''; ?>>
                        <label for="no_purchase_2" class="option-label"><?php echo trans('no'); ?></label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <label>Not Refundable</label>
                    </div>
                    <div class="col-sm-4 col-xs-12 col-option">
                        <input type="radio" name="not_refundable" value="1" id="no_purchase_1" class="square-purple" <?php echo ($category->not_refundable == '1') ? 'checked' : ''; ?>>
                        <label for="not_refundable1" class="option-label"><?php echo trans('yes'); ?></label>
                    </div>
                    <div class="col-sm-4 col-xs-12 col-option">
                        <input type="radio" name="not_refundable" value="0" id="no_purchase_2" class="square-purple" <?php echo ($category->not_refundable == '0') ? 'checked' : ''; ?>>
                        <label for="not_refundable2" class="option-label"><?php echo trans('no'); ?></label>
                    </div>
                </div>
            </div>
