...
<div class="col-md-12 form-header" style="background-color: white;">
...
<div class="col-md-12" style="padding:0px">
	...
	<div class="callout col-md-6" style="margin-top: 5px;background-color: #fff; border-color:#00c0ef;max-width: 600px;margin-left: 20px;">
