			...
			<div class="col-sm-12">
				<div class="table-responsive">
					<table class="table table-bordered table-striped" role="grid">
						...
						<tbody>
						<?php $number = 0;?>
						<?php foreach ($payout_settings as $count => $value):?>
								...
								<tr>
									...
									<td>
										...
										<p class="m-0">
											...
											<button type="button" class="btn btn-xs btn-primary" onclick="payout_settings_modal(<?php echo $value->id?>)" data-toggle="modal" data-target="#accountDetailsModel" data-payment="<?php echo $item->payout_method; ?>"><?php echo trans("see_details"); ?></button>
										</p>
									</td>
