...
<div class="box" style="position:absolute">
    <div class="box-header with-border">
        ...
        <div class="right">
            <a href="<?php echo admin_url(); ?>add-country" class="btn btn-primary btn-add-new">
                    ...
                    <div class="col-sm-12 table-ft">
                        <div class="row">
                            <div class="pull-left">
                                ...
                                <button type="button" class="btn btn-primary" onclick="activate_inactivate_countries('activate');"><?php echo trans("activate_all"); ?></button>
                            </div>
