                                                    ...
                                                    <div class="cart-item-details">
                                                        ...
                                                        <div class="list-item m-t-15">
                                                            ...
                                                            <strong class="lbl-price">
																...
																console_log("\n Converted:".currency_convert($cart_item->total_price, $cart_item->currency,'EUR') );
																console_log("\n formatted_eur:".price_formatted(currency_convert($cart_item->total_price, $cart_item->currency,'EUR'),'EUR'));
																console_log("\n formatted_currency:".price_formatted($cart_item->unit_price, $cart_item->currency));?>
                                                                <?php echo price_formatted(currency_convert($cart_item->total_price, $cart_item->currency,'EUR'),'EUR'); ?>
                                                                <?php if($cart_item->currency != 'EUR'): ?>
                                                        ...
                                                        <div class="list-item">
                                                            ...
                                                            <strong class="lbl-price">
                                                                <?php echo price_formatted(currency_convert($cart_item->total_price, $cart_item->currency,'EUR'),'EUR') ?>
                                                                    <?php if($cart_item->currency != 'EUR'): ?>
                                                                    ( <?php echo price_formatted($cart_item->total_price, $cart_item->currency); ?> )
                                                                    <?php endif;  ?>
                                                                </strong>
                                                        </div>
                                                        ...
                                                        <?php if ($product->product_type != 'digital' && $this->form_settings->shipping == 1): ?>
                                                            <div class="list-item">
                                                                ...
                                                                <strong>
                                                                    <?php echo price_formatted($cart_item->shipping_cost, $cart_item->currency); ?>
                                                                    
                                                                    <?php if($cart_item->currency != 'EUR'): ?>
                                                                    
                                                                    ( <?php echo price_formatted(currency_convert($cart_item->shipping_cost, $cart_item->currency,'EUR'),'EUR') ?> )
