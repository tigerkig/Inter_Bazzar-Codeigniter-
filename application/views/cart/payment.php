									...
									<div class="row">
										<div class="col-12">
											...
											$data = array('total_amount' => $total_amount, 'currency' => $currency, 'mds_payment_type' => $mds_payment_type, 'cart_total' => $cart_total,
												'payment_option' => $cart_payment_method->payment_option);
											...
											} elseif ($cart_payment_method->payment_option == "moka") {
												$this->load->view("cart/payment_methods/_moka", $data);
											...
											}elseif ($this->auth_check && $cart_payment_method->payment_option == "paybyme") {
												$this->load->view("cart/payment_methods/_paybyme", $data);
											} ?>
										</div>
									</div>
								</div>
