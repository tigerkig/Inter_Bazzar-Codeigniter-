                        ...
                        <div class="item">
                            ...
                            <div class="item-right">
                                ...
                                <div class="list-item">
                                    ...
                                    <?php // get_price($cart_item->total_price, 'input'); ?>
                                    <strong class="lbl-price"> <?php echo price_formatted(currency_convert($cart_item->total_price, $cart_item->currency,'EUR'),'EUR') ?>
