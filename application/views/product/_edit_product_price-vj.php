                    ...
                    <div class="col-12 col-sm-4 m-b-sm-15">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-currency wwq" id="basic-addon1"><?php echo get_currency($this->payment_settings->default_product_currency); ?></span>
                                <!-- <input type="hidden" name="currency" value="pound1 <?php //echo $this->payment_settings->default_product_currency; ?>"> -->
                                ...
                                <div id="discount_input_container" class="<?php echo ($product->discount_rate == 0) ? 'display-none' : ''; ?>">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <!-- <input type="hidden" name="currency" value="pound2 <?php //echo $this->payment_settings->default_product_currency; ?>"> -->
                                        </div>
                                    ...
                                    <div id="vat_input_container" class="<?php echo ($product->vat_rate == 0) ? 'display-none' : ''; ?>">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                               ...
                                               <!--  <input type="hidden" name="currency" value="pound3 <?php //echo $this->payment_settings->default_product_currency; ?>"> -->
                                                <!-- <select name="currency" class="form-control">
                                                    <?php if (!empty($currencies)):
                                                        foreach ($currencies as $item): ?>
                                                            <option value="<?php echo $item->code; ?>" <?php echo ($this->payment_settings->default_product_currency == $item->code) ? 'selected' : ''; ?>><?php echo $item->name . " (" . $item->hex . ")"; ?></option>
                            ...
                            <div class="col-12 col-sm-6 m-b-sm-15">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="hidden" name="currency" value="pound4 <?php //echo $this->payment_settings->default_product_currency; ?>">
                                    </div>
...
<?php elseif ($product->listing_type == 'bidding'): ?>
    <input type="hidden" name="currency" value="pound5 <?php //echo $this->payment_settings->default_product_currency; ?>">
<?php endif; ?>
