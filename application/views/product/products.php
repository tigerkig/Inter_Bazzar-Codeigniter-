...
<div id="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 product-list-header">
                <?php if (!empty($category)): ?>
                    <h1 class="page-title product-list-title"><?php echo category_name($category); ?>
                     
                    </h1>
                <?php else: ?>
                    <h1 class="page-title product-list-title"><?php echo trans("products"); ?>
        ...
        <div class="row">
            ...
            <div id="wrapre2" class="col-12 col-md-9">
          <span id="sidebar" class="d-none d-md-block d-lg-block "><i class="icon-menu" aria-hidden="true"></i></span>
                ...
                <div class="product-list-content 121q">
                    <div class="row row-product">
                        <!--print products-->
                        <?php foreach ($products as $product): ?>
                            <div class="col-6 col-sm-6  col-md-4 col-product col-lg-3  ">
...
$('#sidebar').click(function() {
    ...
    $('#content-1').toggle();
	$("#wrapre2").toggleClass("col-md-12"); 
    if($('#content-1').attr('style') == 'display: none;'){

	   $(".col-product").addClass("col-lg-2");
	   $(".col-product").removeClass("col-lg-3");
    
    }else{
        
        $(".col-product").removeClass("col-lg-2");
        $(".col-product").addClass("col-lg-3");
...
<style>
 #sidebar .icon-menu{font-size: 18px;
cursor: pointer;
margin-right: 10px;}
 #sidebar{float:left;
 }
