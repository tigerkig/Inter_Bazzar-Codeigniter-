                ...
                <div class="row">
                    <div class="col-12 col-sm-6 m-b-sm-15">
                        ...
                        <div class="input-group" style="display:flex">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-currency wwq" id="basic-addon1"><?php echo get_currency($product->currency); ?></span>
                                <!-- <input type="hidden" name="currency" value="pound1 <?php //echo $product->currency; ?>"> -->
                                ...
                                <select name="currency" class="form-control" style="height:40px;">
                                    ...
                                    <?php if (!empty($this->currencies)):
                                        foreach ($this->currencies as $item): 
                                        	if(in_array($item['id'],$default_multiple_currency)):
                                        	?>
                                            <option value="<?php echo $item['code']; ?>" <?php echo ($product->currency == $item['code']) ? 'selected' : ''; ?>><?php echo $item['name'] . " (" . $item['hex'] . ")"; ?></option>
                                    		<?php endif; ?>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            ...
                            <div>
                                <input type="text" name="price" style="height: 40px; margin-left: 11px;" id="product_price_input" aria-describedby="basic-addon1" class="form-control form-input price-input validate-price-input" value="<?php echo ($product->price != 0) ? get_price($product->price, 'input') : ''; ?>" placeholder="<?php echo $this->input_initial_price; ?>" onpaste="return false;" maxlength="32" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-3 m-b-sm-15">
                                ...
                                <div id="discount_input_container" class="<?php echo ($product->discount_rate == 0) ? 'display-none' : ''; ?>">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <!-- <input type="hidden" name="currency" value="pound2 <?php //echo $product->currency; ?>"> -->
                                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <div id="vat_input_container" class="<?php echo ($product->vat_rate == 0) ? 'display-none' : ''; ?>">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text input-group-text-currency 3qw" id="basic-addon-vat">%</span>
                                               <!--  <input type="hidden" name="currency" value="pound3 <?php //echo $product->currency; ?>"> -->
                    ...
                    <div class="col-12 m-t-30">
                        <p class="calculated-price">
                            <strong><?php echo trans("calculated_price"); ?> (<?php echo get_currency($product->currency); ?>):&nbsp;&nbsp;</strong>
                        ...
                        <p class="calculated-price calculated_vat_container <?php echo ($product->vat_rate == 0) ? 'display-none' : ''; ?>">
                            <strong><?php echo trans("vat"); ?> (<?php echo get_currency($product->currency); ?>):&nbsp;&nbsp;</strong>
                        ...
                        <p class="calculated-price">
                            <strong><?php echo trans("you_will_earn"); ?> (<?php echo get_currency($product->currency); ?>):&nbsp;&nbsp;</strong>
                    ...
                    <div class="row">
                        ...
                        <?php else: ?>
                            <div class="col-12 col-sm-6 m-b-sm-15">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text input-group-text-currency" id="basic-addon2"><?php echo get_currency($product->currency); ?></span>
