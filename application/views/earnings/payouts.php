                        ...
                        <div class="withdraw-money-container">
                            ...
                            <div class="form-group">
                                <?php if ($this->auth_check): ?>
                                    <?php                                  $button = "";
                                        if(payout_withdrawn_remaining_day($this->auth_user->id) > 0): 
                                            $button = "";
                                        endif;
                                    ?>
                                <?php endif; ?>
                                <button type="submit" class="btn btn-md btn-custom" <?php echo $button; ?>><?php echo trans("submit"); ?></button>
                            </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                    <div class="col-12 col-md-5">
                        <div class="minimum-payout-container">
                            ...
                            <?php if(!empty($this->payout_settings)): ?>
                                <?php foreach($this->payout_settings as $key => $setting): ?>
                                    <?php if($setting->status): ?>
                                    <p><span><?php echo $setting->name; ?></span>:<strong><?php echo price_formatted($setting->minimum_amount, $this->payment_settings->default_product_currency) ?></strong></p>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            <?php endif; ?>
                            ...
                            <?php if ($this->auth_check): ?>
                                ...
                                <?php if(payout_withdrawn_remaining_day($this->auth_user->id) > 0): ?>
                                    <p style="color:red"><?php echo payout_withdrawn_remaining_day($this->auth_user->id) ?> Day left to withdraw money</p>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-orders table-striped">
                            ...
                            <?php foreach ($payouts as $payout): ?>
                                <tr>
                                    <td><?php echo (trans($payout->payout_method)) ? trans($payout->payout_method) : ucwords(str_replace('_',' ',$payout->payout_method)) ; ?></td>
