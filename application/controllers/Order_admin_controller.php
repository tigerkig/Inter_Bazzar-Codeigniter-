...
class Order_admin_controller extends Admin_Core_Controller
{
	...
	public function refunds()
	{
		...
		$pagination = $this->paginate(admin_url() . 'refunds', $this->order_admin_model->get_refunds_count());
		$data['orders'] = $this->order_admin_model->get_paginated_refunds($pagination['per_page'], $pagination['offset']);
        $data['panel_settings'] = $this->settings_model->get_panel_settings();
