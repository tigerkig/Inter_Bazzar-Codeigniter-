...
class Earnings_admin_model extends CI_Model
{
    ...
    public function update_paypal_payout_settings()
    {
        $data = array(
            ...
            'is_commission_active_payout_paypal' => $this->input->post('is_commission_active_payout_paypal', true),

            'commission_type_payout_paypal' => $this->input->post('commission_type_payout_paypal', true),

            'payout_commission_paypal' => $this->input->post('payout_commission_paypal', true),

        );

        if($data["commission_type_payout_paypal"] == 1){
            
            $data["payout_commission_paypal"] = get_price($data["payout_commission_paypal"], 'database');
    ...
    public function update_iban_payout_settings()
    {
        $data = array(
            ...
            'is_commission_active_payout_iban' => $this->input->post('is_commission_active_payout_iban', true),

            'commission_type_payout_iban' => $this->input->post('commission_type_payout_iban', true),

            'payout_commission_iban' => $this->input->post('payout_commission_iban', true),

        );

        if($data["commission_type_payout_iban"] == 1){
            
            $data["payout_commission_iban"] = get_price($data["payout_commission_iban"], 'database');
    ...
    public function update_swift_payout_settings()
    {
        $data = array(
            ...
            'is_commission_active_payout_swift' => $this->input->post('is_commission_active_payout_swift', true),

            'commission_type_payout_swift' => $this->input->post('commission_type_payout_swift', true),

            'payout_commission_swift' => $this->input->post('payout_commission_swift', true),

        );

        if($data["commission_type_payout_swift"] == 1){
            
            $data["payout_commission_swift"] = get_price($data["payout_commission_swift"], 'database');
    ...
    public function delete_payout($id)
    {
     ...
     public function payout_request_notification_count()
    {
