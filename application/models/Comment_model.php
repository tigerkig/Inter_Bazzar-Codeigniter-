...
class Comment_model extends CI_Model
{
    ...
    */
    ...
    public function add_comment()
    {
        ...
        if (!empty($data['product_id']) && !empty($data['comment'])) {
            ...
            $this->send_product_comment_to_admin($data);
        
            $this->send_product_comment_to_seller($data);
        }
    }
    ...
    */
    ...
    /* Add Comment Sent To Admin */
    public function send_product_comment_to_admin($data){
        $comment_by_name = '';
        if($data['user_id'] != 0){
        ...
        $template = $this->order_model->get_email_templates($this->selected_lang->id,'admin_comment_receive','admin');
    ...
    /* Add Comment Sent To Seller */
    public function send_product_comment_to_seller($data){
        ...
        if($product->user_id != 0){
            ...
            $template = $this->order_model->get_email_templates($this->selected_lang->id,'seller_comment_receive','seller');
