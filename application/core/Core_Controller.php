...
class Core_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        // payout settings
        $this->payout_settings  = $this->settings_model->get_payout_setting();
    ...
    public function get_currencies_array()
    {
        ...
        if (!empty($currencies)) {
            foreach ($currencies as $currency) {
                $array[$currency->code] = array('id' => $currency->id,'name' => $currency->name, 'symbol' => $currency->symbol, 'hex' => $currency->hex, 'code' => $currency->code);
            }
        }
        return $array;
    }
