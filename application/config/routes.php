...
foreach ($languages as $language) {
    if ($language->status == 1) {
        ...
        $route[$routes->admin . '/sell_now'] = 'product_controller/add_product';

        /*product*/
        $route[$key . $routes->start_selling]['GET'] = 'product_controller/start_selling';
        $route[$key . $routes->sell_now]['GET'] = 'product_controller/add_product_user';
        // $route[$key . $routes->product-details.'/(:num)'] = 'product_admin_controller/product_details/$1';
        ...
        $route[$key . $routes->sell_now . '/product_details_user/(:num)']['GET'] = 'product_controller/edit_product_details_user/$1';
        ...
        $route[$key . $routes->orders . '/' . $routes->refund_orders]['GET'] = 'order_controller/refund_orders';
        ...
        $route[$key . $routes->sales . '/' . $routes->refunded_sales]['GET'] = 'order_controller/refunded_sales';
        $route[$key . $routes->sales . '/(:num)']['GET'] = 'order_controller/sale/$1';
        /*earnings*/
...
// $route[$routes->admin] = 'common_controller/admin_login';
//login
$route[$routes->admin . '/login'] = 'common_controller/admin_login';

// $route[$routes->admin . '/forgot_password'] = 'auth_controller/admin_forgot_password';

// $route[$routes->login] = 'common_controller/admin_login';

// $route[$routes->admin . 'invoice/(:num)']['GET'] = 'order_controller/invoice/$1';
/*navigation routes*/
$route[$routes->admin . '/navigation'] = 'admin_controller/navigation';
$route[$routes->admin . '/sell_now/(:num)'] = 'product_controller/admin_edit_product/$1';

// $route[$routes->admin . '/invoice/(:num)']['post'] = 'order_controller/invoice/$1';
...
$route[$routes->admin . '/refunds'] = 'order_admin_controller/refunds';
$route[$routes->admin . '/invoices'] = 'order_admin_controller/invoices';


////////////////////
$route[$routes->admin . '/invoice_view'] = 'order_controller/invoice';
// $route['invoice_view/:id'] = 'Order_controller/invoice';
...
$route[$routes->admin . '/filter_members'] = 'product_admin_controller/filter_members';
...
$route[$routes->admin . '/import-products'] = 'product_admin_controller/import';
$route[$routes->admin . '/import-products-post'] = 'product_admin_controller/import_post';
...
$route[$routes->admin . '/import-export'] = 'admin_controller/import_export';
$route[$routes->admin . '/exportCSV'] = 'admin_controller/exportCSV';
$route[$routes->admin . '/exportDB'] = 'admin_controller/exportDB';
$route[$routes->admin . '/delete-db-backup/(:num)'] = 'database_controller/deletedata/$1';
$route[$routes->admin . '/rollback-db-backup/(:num)'] = 'database_controller/rollbackBackup/$1';
$route[$routes->admin . '/rollbackBackup_upload/(:num)'] = 'database_controller/rollbackBackup_upload/$1';
/*languages routes*/
...
$route[$routes->admin . '/export-language/(:num)'] = 'language_controller/export_language/$1';
$route[$routes->admin . '/import-language/(:num)'] = 'language_controller/import_language/$1';
...
$route[$routes->admin . '/email-templates/(:num)'] = 'emailtemplates_admin_controller/index/$1';

$route[$routes->admin . '/add-email-templates'] = 'emailtemplates_admin_controller/add';

$route[$routes->admin . '/edit-email-templates'] = 'emailtemplates_admin_controller/edit';

$route[$routes->admin . '/set-language-post'] = 'language_controller/set_language_post';

$route[$routes->admin . '/add-language-post'] = 'language_controller/add_language_post';

$route[$routes->admin . '/delete-language-post'] = 'language_controller/delete_language_post';

$route['test']['GET'] = 'cart_controller/test';
// $route[$routes->admin . '/do_upload'] = 'database_controller/do_upload';
// $route[$routes->admin . '/do_upload']['POST'] = 'database_controller/do_upload';
...
$route['ajax_requestPost']['post'] = 'order_controller/ajaxRequestPost';