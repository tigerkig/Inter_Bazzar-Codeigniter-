...
// $route['login'] = 'common_controller/login';
...
$route['clear-cart']['GET'] = 'cart_controller/clear_cart';
...
$route['paybyme-payment-post']['POST'] = 'cart_controller/paybyme_payment_post';
...
// Author : 225
$route['set-other-payout-account-post']['POST'] = 'earnings_controller/set_other_payout_account_post';
...
$route['add-product-post-user']['POST'] = 'product_controller/add_product_post_user';
...
$route['refund-request']['POST'] = 'product_controller/refund_request';

$route['refund-request-update']['POST'] = 'order_controller/edit_refund_order';

$route['refund-approve']['POST'] = 'order_controller/approve_refund';

$route['refund-cancel']['POST'] = 'order_controller/cancel_refund';

/* Author : 225 */
$route['set-default-location-get']['GET'] = 'home_controller/set_default_location_get';

$route['get-country-id']['GET'] = 'ajax_controller/get_country_id';

$route['add-payout-settings']['POST'] = 'earnings_admin_controller/add_payout_setting_post';

$route['update-payout-settings']['POST'] = 'earnings_admin_controller/update_payout_setting_post';

$route['delete-payout-settings']['GET'] = 'earnings_admin_controller/delete_payout_setting_get';
/* Author : 225 */

/*Order Notification*/
$route['order-notification'] = 'ajax_controller/get_order_notification';
/*Bank Transfer Notification*/
$route['bank-transfer-notification'] = 'ajax_controller/get_bank_transfer_notification';
// Order Complete With Bank Notification
$route['order-complete-bank-notification'] = 'ajax_controller/order_complete_bank_notification';
// Payout Request notification
$route['payout-request-notification'] = 'ajax_controller/payout_request_notification';
// Incoming Contact Message notification
$route['incoming-contact-message-notification'] = 'ajax_controller/incoming_contact_message_notification';

$route['refunds-p-notification'] = 'ajax_controller/refunds_p_notification';
$route['refunds-c-notification'] = 'ajax_controller/refunds_c_notification';
$route['refunds-can-notification'] = 'ajax_controller/refunds_can_notification';



$route['paybyme-success']['GET'] = 'cart_controller/paybyme_success_page';

$route['paybyme-failure']['GET'] = 'cart_controller/paybyme_error_page';

$route['paybyme-success-d']['GET'] = 'cart_controller/paybyme_success_page_d';

$route['paybyme-failure-d']['GET'] = 'cart_controller/paybyme_error_page_d';

$route['paypal-payment-post-d']['GET'] = 'cart_controller/paypal_payment_post_d';
...
$route['stripePost']['post'] = "Cart_controller/stripePost";